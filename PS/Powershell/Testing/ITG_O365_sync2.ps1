$key = "ITG.b9161897aee495737ed8fb6d249d00e5.f3z_tWXPklSYVLB61fyHhLkKeWdJSU-o2eO_OKWUEkKsTrvJzCKByyW9wo1nQV3R"
$assettypeID = 100431
...
Write-Host "Getting domains" -ForegroundColor Green
$companyInfo = Get-MsolCompanyInformation
    
$customerDomains = Get-MsolDomain | Where-Object {$_.status -contains "Verified"}
...
$licensedUsers = $null
$licensedUsers = get-msoluser | Where-Object {$_.islicensed} | Sort-Object UserPrincipalName
if ($licensedUsers) {
...
$hash = [ordered]@{
    ...
    TenantId          = (($Licenses[0].AccountSkuId).split(":"))[0]
